...
#   apu_referral_attribution.xml -> inviter_for_<node> plus
#       attributed_contacts_v1 on the invitee side, credited_invitees_v1 on the
#       inviter side. This is what makes crediting idempotent.
# ============================================================================
...
Write-Output '  invitee : apu_referral_attribution.xml has inviter_for_<node> and attributed_contacts_v1'
