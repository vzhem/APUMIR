...
$StatePath = Join-Path $env:TEMP 'apu-v11.16.16-prerelease-backup-v3.json'
$FlashStatePath = Join-Path $MetadataBackup 'apu-v11.16.16-prerelease-backup-v3.json'
...
try {
    ...
    $script:FetchWarning = 'Network intentionally skipped in offline v3 after the confirmed GitHub connectivity failure.'
