...
$Version = "v11.16.29"
$Prefix = Join-Path $env:TEMP "apu-referral-r1-wire-build"
...
if ($Existing.Count) { throw "R1 wire build already attempted; preserve evidence" }
...
Write-Host "REFERRAL R1 WIRE BUILD PASS"
