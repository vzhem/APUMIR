...
$Script    = "p2p-relay"
$WorkerUrl = "https://raw.githubusercontent.com/vzhem/APUMIR/v11.74.2/tools/worker/p2p_relay_worker.js"
...
Write-Host ("  worker.js: $lines lines (expected 634)")
if ($lines -lt 600) {
...
$raw = curl.exe -s -X PUT "https://api.cloudflare.com/client/v4/accounts/$Account/workers/scripts/$Script" `
    -H "Authorization: Bearer $Token" `
