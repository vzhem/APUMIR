...
| Друзей | Статус | Outbound media unlock / лимит одного файла* |
|---:|---|---|
| 0 | Без ранга | только текст; получение media всегда разрешено |
| 1 | **Первый связной** | отправка фото до 5 MiB |
| 3 | **Круг друзей** | фото и произвольные файлы до 10 MiB |
| 10 | **Проводник** | фото, файлы и видео до 25 MiB |
| 20 | **Организатор** | до 50 MiB |
| 30 | **Навигатор** | до 100 MiB |
| 50 | **Амбассадор** | до 250 MiB |
| 100 | **Строитель сообщества** | до 500 MiB |
| 200 | **Хранитель сети** | до 750 MiB |
| 300 | **Маяк APU** | до 1 GiB |
| 500 | **Лидер сообщества** | до 1.5 GiB |
| 700 | **Легенда APU** | до 2 GiB |
| 1 000 | **Создатель сети** | до 4 GiB |
