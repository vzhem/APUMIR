...
| 5.7 Рой, этап 8: два хранителя на файл и инвентарь недостающего | 🟡 | с v11.70.18: `FileCustodySender.TARGET_HOLDERS`=2, `CUSTODY_WANT` (тип 8), `ACK_RELEASE`; карта — `CHANNEL_SWARM_DESIGN.md` §9.4 «Этап 8». На телефонах не проверено. Подробности — `AI_HANDOFF.md`, пункт 0m |
