...
| 5.12 Системный жест «Назад» внутри темы → список тем (замечание владельца 2026-09-15) | 🟡 | с v11.70.22: `BackHandler` в `GroupChatScreen`. Владелец подтвердил после v11.70.21: заголовок темы и закреп файла работают. Подробности — `AI_HANDOFF.md`, пункт 0r |
