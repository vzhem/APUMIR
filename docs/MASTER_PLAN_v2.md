...
| 5.15 Ядро, этап K2: файл группы полосами от нескольких сидов (общий манифест `grp_`, `create_group_file_manifest`, `GroupFileSeeder`, `WANT` тип 9, `fwant#g1`) | ✅ | v11.70.25 (2026-09-17, Latest): карта — `CHANNEL_SWARM_DESIGN.md` §9.4 «Этап K2», детали — `AI_HANDOFF.md`, пункт 0u. На телефонах не проверено |
