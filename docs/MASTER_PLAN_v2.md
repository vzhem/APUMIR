...
| 5.11 Замечания с телефона после v11.70.20 + рой, этап 11 (`fnone`, уборка файлов при выходе из группы) | 🟡 | с v11.70.21 (выпуск 2026-09-15): заголовок темы в группе, закреп файла, «у меня нет» → следующий сид сразу, `GroupFileStore.deleteGroup`. Подробности — `AI_HANDOFF.md`, пункт 0q |
