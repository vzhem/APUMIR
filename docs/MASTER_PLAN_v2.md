...
| 5.9 Рой, этап 9: файлы в группах раздают участники | 🟡 | с v11.70.19 (выпущен 2026-09-15, тег на `abbb5c4`): скрепка в группе, визитка `APUFILE1:` в сообщении, `fwant`/`fhave`, `GroupFileSwarm`; карта — `CHANNEL_SWARM_DESIGN.md` §9.4 «Этап 9». На телефонах не проверено. Подробности — `AI_HANDOFF.md`, пункт 0o |
