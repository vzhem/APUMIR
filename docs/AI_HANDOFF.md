...
0h. **v11.70.12 - в работе (2026-09-11): рой, этап 6 - место под пересылку.**
   ...
   сообщений ядра ограничена числом, не байтами (FFI не менялся); чужих
   файлов на хранении ещё нет - это следующий шаг этапа 6.
