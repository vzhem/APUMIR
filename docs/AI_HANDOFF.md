...
0f. **v11.70.10 - рой, этап 4: комментарии больших каналов через сборщиков
   (коммит `fdf830e` в ветке `arena/01a07cda-apumir`; выпуск см.
   `START_HERE.md` §3 - если там его нет, тег ещё не ставился).** Карта
