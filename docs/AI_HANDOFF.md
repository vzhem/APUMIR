...
0m. **v11.70.18 (рой, этап 8): два хранителя на файл, инвентарь
   недостающего, отпускание копий.** Просьба владельца 2026-09-13
   ...
   --tests '*Custody*'`). Совместимость: телефон < v11.70.18 на месте
...
0l. **v11.70.17: автообновление файла резервной копии по расписанию.**
...
0k. **v11.70.16 выпущен 2026-09-13 (Latest, тег `3871c33`): резервная
   копия профиля целиком и восстановление из файла.** Просьба владельца
