...
0b. **v11.70.6 - рой, этап 1 (в выпуске; итог сборки см. START_HERE §3).**
...
0a. **Раздача роем (главная задача после v11.70.4).** Владелец 2026-09-09:
   ...
   (манифесты) - v11.70.6; дальше этап 2 (первая волна K, `pwant` полосами,
   `peers` при N > 100). Ничего из роя на телефонах не проверено.
