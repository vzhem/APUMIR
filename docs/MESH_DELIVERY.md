...
- **Надёжность receipt:** r1 reconnect и r2 unique retained receipt+cleanup проверены на
  ...
  v11.16.12 install PASS 3/3; appId/UID/firstInstallTime/dataDir preserved. Controlled launch/
  liveness pending. EMQX/fanout не подключены; public delivery probe до
