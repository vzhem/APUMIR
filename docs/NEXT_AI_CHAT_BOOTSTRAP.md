...
> **ЭТОТ ФАЙЛ УСТАРЕЛ (написан 2026-08-22) и НЕ является точкой входа.**
> Точка входа — `docs/START_HERE.md`. Всё ниже читай как историю проекта и
> источник правил владельца; конкретные версии, коммиты, имена веток и состояние
> релиза отсюда брать нельзя — они описывают состояние на 2026-08-22.
