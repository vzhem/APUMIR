 ...
 * раздаёт СВОЮ зашифрованную азбуку ВСЕМ знакомым телефонам (решение владельца
 * 2026-09-22: лимит «5 хранителей» снят — копий сколько угодно, в настройках
 * просто показывается число сохранивших). Набор стабилен (копии не пересылаются
 * туда-сюда), ни от кого не зависит персонально; выпавший телефон заменяется
 * следующим — сам, без сервера. Рейтинг сознательно НЕ используется (решение
 * владельца): у «лучших» общие слабые места, полный обход независим.
 *
