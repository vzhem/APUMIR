 ...
 *
 * Решение владельца от 2026-09-04: ровно 20 штук, все разные и все
 * доброжелательные. Ничего осуждающего (палец вниз, слёзы, злость) в наборе
 * нет: реакция в APU - это поддержка, а не оценка.
 *
 * Порядок важен: он же порядок показа в пузыре, самые частые - первыми.
 * Значки берутся из базового набора Unicode, который рисуют все телефоны
 * начиная с Android 8, поэтому «квадратиков» ни у кого не будет.
 */
