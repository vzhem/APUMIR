...
data class PostManifest(
    ...
    companion object {
        ...
        /**
         * Больше кусков в одном посте не бывает: 6 фото × 3 куска. Куски
         * длинного текста (этап 3) делят с фото этот же предел - отправка
         * отказывает, если текст и фото вместе в него не укладываются.
         */
